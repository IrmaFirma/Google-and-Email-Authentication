...
import 'package:testing_app/components/form_submit_button.dart';
...
class _EmailPasswordSignInPageState extends State<EmailPasswordSignInPage> {
  ...
  void _showSignInError(
      EmailPasswordSignInModel model, FirebaseException exception) {
    ...
    try {
      ...
      if (success) {
        if (model.formType == EmailPasswordSignInFormType.signIn ||
            model.formType == EmailPasswordSignInFormType.register) {
